...
class ScoutFuzzyEngine:
    def __init__(self):
        ...
        self.llm_match = ctrl.Antecedent(np.arange(0, 11, 0.5), 'room_match')
    ...
    def get_weighted_rules(self, priorities):
        ...
        # PRICE: keep influential, but not dominating everything
        ...
        # Resolve expensive+near using priorities; location can win when it is at least as important
